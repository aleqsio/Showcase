...
the genetic algorithm used for training seems to fail with a highier ammount of weights to adjust.
...
(by using pie chart selection those individuals with highest fitness have also a highiest chance of beeing picked)
...
0
It may be neccessary to restart the application if the results at the end do not match the expected values (fitness stagnates at around 400).
